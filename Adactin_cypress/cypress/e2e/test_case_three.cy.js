...
checkInDate.setDate(currentDate.getDate() - 5); // 5 days from now
const checkOutDate = new Date(currentDate);
checkOutDate.setDate(currentDate.getDate() - 3); // 6 days from now
...
describe('test case 3', () => {
  it('Verify if it gives an error for past date', () => {
